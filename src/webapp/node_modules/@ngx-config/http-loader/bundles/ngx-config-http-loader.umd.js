(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@ngx-config/http-loader', ['exports', '@angular/common/http', '@angular/core'], factory) :
    (global = global || self, factory((global['ngx-config'] = global['ngx-config'] || {}, global['ngx-config']['http-loader'] = {}), global.ng.common.http, global.ng.core));
    ...
    var ConfigHttpLoader = (function () {
        ...
        ConfigHttpLoader.prototype.loadSettings = function () {
            ...
            return new Promise(function (resolve, reject) {
                var http = core.resolveForwardRef(_this.http);
                http.get(_this.endpoint).subscribe(resolve, function () { return reject('Endpoint unreachable!'); });
            });
        };
        ConfigHttpLoader = __decorate([
            __param(0, core.Inject(core.forwardRef(function () { return http.HttpClient; }))),
            __metadata("design:paramtypes", [http.HttpClient, String])
        ], ConfigHttpLoader);
        return ConfigHttpLoader;
    }());

    exports.ConfigHttpLoader = ConfigHttpLoader;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-config-http-loader.umd.js.map
